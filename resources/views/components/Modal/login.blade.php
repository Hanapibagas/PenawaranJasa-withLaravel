        ...
        <div
            ...
            <div class="p-5 rounded-t-xl text-center mt-5 mx-10">
                ...
                <p class="text-gray-400 mt-1 text-sm">
                    Silahkan masukkan ke email & password
                </p>
            </div>
            <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="inline-block text-xs text-gray-400">
                            <label class="inline-flex items-center mt-3">
                                <input type="checkbox"
                                    ...
                                    class="ml-2 text-gray-400">Ingatkan saya</span>
                            </label>
                        </div>
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <p href="#" class="text-center py-5">
                        Belum mempunyai akun? <a href="#" class="text-serv-button"
                            onclick="toggleModal('loginModal');toggleModal('registerModal') ">Daftar</a>
                    </p>
                </div>
            </form>
        </div>
